        ...
        <section className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
              Habit Tracker is designed to support you, not stress you. There are no streaks, no guilt-inducing alerts—just a simple, flexible system that helps you build habits at your own pace. Forget the pressure of perfection. Aim lower, stay consistent, and keep moving forward in a way that feels right for you.
              </p>
            </div>
          </div>
        </section>
